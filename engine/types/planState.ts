...
export type Child = {
  ...
  age: number;
  monthlyExpense?: number; // engine zeroes this out once child.age + yearIndex >= 18
};
...
export type BalanceSheet = {
  ...
  home: {
    ...
    currentValue: number;
    appreciationPct?: number; // annual %; if set, engine applies compound appreciation year-over-year
  };
};
